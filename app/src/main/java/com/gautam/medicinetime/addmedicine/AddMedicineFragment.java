...
public class AddMedicineFragment extends Fragment implements AddMedicineContract.View {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        editText.setText(getActivity().getIntent().getStringExtra("text"));
        editText.setVisibility(View.INVISIBLE);
        editMedName.setText(getActivity().getIntent().getStringExtra("text"));
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        setCurrentTime();
        setSpinnerDoseUnits();
        openocr.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    View.OnClickListener setClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://www.himanshushekhar.ml/medicine.php"
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("dose", tvDoseQuantity.getText().toString());
                    params.put("days", dayOfWeekList[0]+":"+dayOfWeekList[1]+":"+dayOfWeekList[2]+":"+dayOfWeekList[3]+":"+dayOfWeekList[4]+":"+dayOfWeekList[5]+":"+dayOfWeekList[6]);
                    params.put("name", editMedName.getText().toString());
                    params.put("time", tvMedicineTime.getText().toString());
                    return params;
                }
            };
